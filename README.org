...
[[file:./doc/SimulaDesktop.png][https://d.tube/#!/v/sudoreboot/t026ny0m]]
...
*Chat room.* Simula is in alpha phase, and can be difficult to get working on many setups. For help with installation, please visit our [[https://gitter.im/SimulaVR/Simula][chat room]].
...
3. *Ensure udev rules are up to date.* Ensure that ~/lib/udev/rules.d/60-HTC-60-HTC-Vive-perms.rules~ exists and contains the following:
